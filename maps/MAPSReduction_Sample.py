...
#------------------------------------------------------------------------------------#
   ...
   def def_main_properties(self):
       ...
       #
       prop['incident_energy'] = [80]
       prop['energy_bins'] =[-0.1,0.002,0.9]

       # the range of files to reduce. This range ignored when deployed from autoreduction,
       # unless you going to sum these files. 
       # The range of numbers or run number is used when you run reduction from PC.
       prop['sample_run'] =33652
       prop['wb_run'] = 30331
       prop['sum_runs']=False
       #
       ...
       #prop['monovan_run'] = 26655  #  vanadium run in the same configuration as your sample Ei55_150 26664. Ei90_150 26667
       prop['monovan_run'] = None
       prop['sample_mass'] = 35.43
       prop['sample_rmm'] = 397.15
       return prop
#------------------------------------------------------------------------------------#
   @AdvancedProperties
   def def_advanced_properties(self):
      ...
      #prop['map_file'] = "MAPS_rings0_25deg.map"
      prop['monovan_mapfile'] = "4to1_mid_lowang_174.map"
      #note modified monovan map to avoid lowest angle detectors with splurge from guide
      #prop['hardmaskOnly']="4to1_181_msk.xml" # disable diag, use only hard mask
      prop['hard_mask_file'] = "4to1_183_msk.xml"
