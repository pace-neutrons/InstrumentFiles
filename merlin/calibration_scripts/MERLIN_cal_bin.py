...
#====================== calibration input  ===========================
calibration_runs = [69987]                      # calibration bin run
...
oldcal    = '/usr/local/mprogs/InstrumentFiles/merlin/det_merlin_cycle244.dat'
newcal    = '/usr/local/mprogs/InstrumentFiles/merlin/det_merlin_cycle245.dat'
newrings  = 'MERLIN_rings_244.xml'
do_plot = True  # Plots door 1 or not
#======================================================================
...
# assumes the slits are 1 mm thick
    ...
    if inst.lower() == 'merlin':
        ...
        rad_ratio = 325 / 2.5 #this ratio is bad for the detectors above and below the beam stop
        #delta_slits = [79.5,27.,59.,60.,53.5,52.5]
...
fpD1_bad     = TubeCalibFitParams([50., 151., 186., 256., 329., 396., 460.], peak_height, peak_width)
fpD9_bad     = TubeCalibFitParams([50., 148., 179., 255., 330., 397., 460.], peak_height, peak_width)
...
if do_plot:
    ...
    calibrationTable = calibrate(ws, 'MERLIN/door1', known_pos, peaks_form, fitPar=fpD1_bad, margin=30, rangeList=[8,19,23], calibTable=calibrationTable)
...
calibrationTable = calibrate(ws, 'MERLIN/door9', known_pos, peaks_form, fitPar=fpD9_bad, margin=10, rangeList=[16], plotTube=[16], calibTable=calibrationTable)
